...
for $C$ to have $0$ in its interior and be convex. Indeed, since $0\in C$ for such
...
We claim that for $p\colon \Hcal \to [0, +\infty]$ to be continuous, it suffices
for $C$ to have $0$ in its interior, be closed and convex.
...
depends only on $\varepsilon$, implying that $p$ is in fact uniformly continuous on
$\Hcal$.
