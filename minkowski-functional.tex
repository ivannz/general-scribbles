...
% \begin{equation*}
%   \{p\in \alpha U\}
%     = \bigl\{ \alpha^{-1} p \in U \bigr\}
%     = \bigl\{x \colon p(x \alpha^{-1} ) \in U \bigr\}
%     = \bigl\{\alpha z \colon p(z) \in U \bigr\}
%     = \alpha \{ p\in U \}
%     \,.
% \end{equation*}
\begin{equation*}
...
% \begin{align*}
%   \{p \in \alpha U\}
%     &= p^{-1} \bigl( \alpha U \bigr)
%     = p^{-1} \bigl( \sigma_\alpha (U) \bigr)
%     = \bigl(p^{-1} \circ \sigma_\alpha \bigr)(U)
%     = \bigl(\sigma_\alpha^{-1} \circ p\bigr)^{-1}(U)
%     \\
%     &= \bigl(p \circ \sigma_\alpha^{-1} \bigr)^{-1}(U)
%     = \bigl(\sigma_\alpha \circ p^{-1} \bigr)(U)
%     = \sigma_\alpha \bigl(p^{-1}(U)\bigr)
%     = \alpha \{p\in U\}
%     \,,
% \end{align*}
