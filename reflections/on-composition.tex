...
\section{Reflections on analysis} % (fold)
\label{sec:reflections_on_analysis}

% section reflections_on_analysis (end)

% \section{Unedited} % (fold)
% \label{sec:unedited}

% On composing texts
% problem statement and background
%% 1 - "A character is in a zone of comfort" -- current state of affaiirs in the main subject area
%% 2 - "... but they want something" -- statement of a particular problem or a gap
%% 3 - "they enter an unfamiliar situation" -- what are the ways to address the outliend gap
%% 4 - "Adapt to it" -- propose a modification or a new method
% materials/methods
%% 5 - "Get what they wanted" -- develop a modification and carry out experiments
% results
% discussion / conclusions
%% 6 - "Pay a heavy price for it" -- discuss limitations and criticise the scope of methods
%% 7, 8 - "Then return to their fimiliar situation ... having changed" -- merits and future direction

%%% 8 stages of a research paper
%% current state of the art
%% what do we want
%% how do others get there
%% how do i get there
%% what were the challenges on the way to there
%% how do i understand if i got to where i wanted
%% what are the disadvantages of my way, criticism, can it be made better with more effort
%% where does all this analysis put my way in the general picture of current art

% paragraph structure
%% Topic sentence and supporting sentences, and some paragraphs also have a concluding sentence.
%% The topic sentence states the main topic and the specific area to be discussed (controlling idea).
%% Supporting sentences develop the topic sentence. The concluding sentence, if present, leaves
%% the reader with a summary of important points to remember.


% on critical thinking and scientific communication
%% Additionally, skills such as the ability to relate and interlink evidence, to lend
%% permanence to thoughts and speech, to enable one’s writing to serve as a future reference
%% to others, and to protect intellectual property rights1 need to be developed and tempered
%% over a period of time.
%% Practice scientific writing to develop habits of reflection and the ability to relate
%% and interlink evidence.
%% clear, try to minimize the number of ideas in each sentence. Make sure that it's easy
%% for your reader to understand your meaning.
%% concise in your communication, you stick to the point and keep it brief.
%% concrete, then your audience has a clear picture of what you're telling them. There are
%% details (but not too many!) and vivid facts, and there's laser-like focus. Your message is solid.
%% communication is correct, if it fits your audience. And correct communication is also
%% error-free communication.
%% communication is coherent, it's logical. All points are connected and relevant to the
...
%% passive-aggressive tones. You keep your reader's viewpoint in mind, and you're empathetic to their needs.

% Annotated bibliography
%% 1) COMPLETE  information about the source formatted according to the IEEE rules;
%% 2) Summary (about 1/3 of the total text == 50-70 words;
%% 3) Include ONE direct quotation, punctuated and formatted according to the rules.
%% 4) Evaluation/ assessment; Why is this material good?
%% 5) Reflection. How would you use it in your paper?

% read once, highlighting stuff, then on the ssecond read produce a write-up that
% summarizes the key point relevnat to the study. Follow the proposed pattern:
% short overview and recap, criticism and evaluation, followed by how thie is intended
% to be used.

% > stop thinking that they are professional and you're not -- you are allowed to criticise
% the work -- it develops your own mental capacity

% on research and engineering
%% # start with experiments on small/toy datasets, draw conclusions
%% # run small experiment on large datasets and get a feel of the hyperparameters
%% # conduct large experiments on large datasets
%% (writing papers)
%% * Test out an idea in a small-scale experiment
%%   + Then figure out key variables in more streamlined large-scale experiments
%% * Do ablation study under various simple settings
%%   + study the role of each component/assumption/condition
%%   + important implementation details
%% * Read and pour thoughts onto the paper
%%   + Support claims by citations/experiment/proof, or qualify them linguistically
%%   + idea is what you want convey to the reader
%% * Stop whining: once accumulated momentum try not to lose it by distracting
%% yourself with adjacent or unrelated activity
% (engineering) building useful tools
%% (science) understanding/discovering underlying principles
% (top down coding)
%% start with a top-level scaffolding and then specialize downwards
%% always make a `.git` repo!

% % section unedited (end)
